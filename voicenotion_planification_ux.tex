...
\begin{figure}[H]
    \centering
    % PLACEHOLDER: Ajoutez ici l'image illustrant les trois personas (par exemple, avatars ou diagramme).
...
\begin{figure}[H]
    \centering
    % PLACEHOLDER: Ajoutez ici le wireframe de l'application mobile (ex: assets/docs/wireframe_app.png)
    %\includegraphics[width=0.8\textwidth]{assets/docs/wireframe_app.png}
...
\begin{figure}[H]
    \centering
    % PLACEHOLDER: Ajoutez ici le wireframe du site web (ex: assets/docs/wireframe_web.png)
    %\includegraphics[width=0.8\textwidth]{assets/docs/wireframe_web.png}
...
\begin{figure}[H]
    \centering
    % PLACEHOLDER: Ajoutez ici un board synthétique du design system (ex: assets/docs/design_system_board.png)
    %\includegraphics[width=0.9\textwidth]{assets/docs/design_system_board.png}
